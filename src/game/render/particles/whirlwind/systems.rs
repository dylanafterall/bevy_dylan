...
// -----------------------------------------------------------------------------
pub fn spawn_whirlwind(mut commands: Commands, mut effects: ResMut<Assets<EffectAsset>>) {
    const WHIRLWIND_POS: Vec3 = Vec3::new(90.0, -45.0, 0.0);
    ...
    size_gradient.add_key(0.3, Vec2::new(0.6, 0.06));
    ...
    let zero = writer.lit(WHIRLWIND_POS);
    ...
    commands.spawn((
        ...
        ParticleEffectBundle {
            ...
            transform: Transform::from_translation(WHIRLWIND_POS),
            ..Default::default()
        },
    ));
}
